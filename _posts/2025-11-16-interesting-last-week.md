...
> Oh, look. Another terraform killer! 
> Sounds complicated.
...
<a name="sudo-rs Affected By Multiple Security Vulnerabilities - Impacting Ubuntu 25.10 - Phoronix"></a>[sudo-rs Affected By Multiple Security Vulnerabilities - Impacting Ubuntu 25.10 - Phoronix](https://www.phoronix.com/news/sudo-rs-security-ubuntu-25.10) - The Ubuntu 25.10 transition to using some Rust system utilities continues proving quite rocky

<a name="Weebl & Bob Compilation No.1 - YouTube"></a>**[Weebl & Bob Compilation No.1 - YouTube](https://youtu.be/F2tC7G2SCLM?si=xDNkY1CJ5slM6KV3)**

{% include youtube.html id="F2tC7G2SCLM" %}
...
<a name="What if ALL the sun’s power was focused in one place? - YouTube"></a>**[What if ALL the sun’s power was focused in one place? - YouTube](https://youtu.be/qu8nx1qUwEU?si=x8pI2F3lCVPLbcPG)**

{% include youtube.html id="qu8nx1qUwEU" %}
...
{% include youtube.html id="d-L264UQoJk" %}
...
<a name="10 Weird Facts About The Goodies You Never Knew! - YouTube"></a>**[10 Weird Facts About The Goodies You Never Knew! - YouTube](https://youtu.be/93sKWN2zv38?si=a3q2hbFdeUeWOCk4)**

{% include youtube.html id="93sKWN2zv38" %}
